...
class Mouse extends Module {
  ...
  destroy () {
    this.sliderInstance.boardList.removeEventListener('mousedown', this._mouseDown);
    this.sliderInstance.boardList.removeEventListener('mouseup', this._mouseStop);
    this.sliderInstance.boardList.removeEventListener('mouseleave', this._mouseStop);
    this.sliderInstance.boardList.removeEventListener('mousemove', this._mouseMove);

    if (this.mouseStopTimeOut) {
      globalThis.clearTimeout(this.mouseStopTimeOut);
    }
  }
  ...
  mouseStop (event) {
    ...
    this.mouseStopTimeOut = globalThis.setTimeout(() => {
